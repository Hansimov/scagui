function downSample(~,~,obj)
    ...
    samples_downed = cell(obj.trace_num,1);
    ...
    for i = 1:obj.trace_num
        ...
        samples_downed{i} = traceDownsample(sample_vec,down_rate);
    end
    ...
    if ~canceled
        obj_new.trs_samples = samples_downed;
        obj_new.trs_info.ns{2} = size(obj_new.trs_samples{1},2); % Number of Samples
